...
2. To develop on local, run `npm link pages/react-basic/node_modules/react` at project root after npm install in pages/react folder to fix [this issue](https://github.com/facebook/react/issues/13991) when local package is used with React.
