...
export const TextInput = ({ name, id, ref, value, onChange, onKeyDown, error = "", form, fieldSpec: { description, type, defaultValue, placeholder, required, readOnly } }) => {
...
export const NumberInput = ({ name, id, ref, value, onChange, onKeyDown, error = "", form, fieldSpec: { description, defaultValue = 0, required } }) => {
    return (
        <label htmlFor={id}>
            <span>{description || `${name}: `}</span><br />
            <input
...
export const BooleanInput = ({ name, id, ref, value = '', onChange, error = "", form, fieldSpec: { description, options = [], required }}) => {
    return (
        <label htmlFor={id}>
