...
export const TextInput = ({ name, id, description, value = '', onChange, error }) => {
    return (
        <label>
            {description || `${name}: `}
            <input
...
export const NumberInput = ({ name, id, description, value = 0, onChange, error }) => {
    return (
        <label>
            {description || `${name}: `}
            <input
...
// TODO: html select
export const SelectInput = ({ name, id, description, value = '', onChange, options = [], error }) => {
    return (
        <label>
            {description || `${name}: `}
            <select
